...
INSERT INTO "new_CreatorProfile" ("allowDiscoveryUseLocation", "availability", "coverUrl", "createdAt", "creatorId", "id", "isVerified", "locationEnabled", "locationGeohash", "locationLabel", "locationLat", "locationLng", "locationPlaceId", "locationPrecisionKm", "locationRadiusKm", "locationVisibility", "offerTags", "plan", "popclipPreviewLimit", "responseSla", "updatedAt", "vipOnly", "visibilityMode", "websiteUrl") SELECT "allowDiscoveryUseLocation", "availability", "coverUrl", "createdAt", "creatorId", "id", "isVerified", "locationEnabled", "locationGeohash", "locationLabel", "locationLat", "locationLng", "locationPlaceId", "locationPrecisionKm", "locationRadiusKm", "locationVisibility", "offerTags", "plan", "popclipPreviewLimit", "responseSla", "updatedAt", "vipOnly", "visibilityMode", "websiteUrl" FROM "CreatorProfile";
