...
INSERT INTO "new_CreatorProfile" ("allowDiscoveryUseLocation", "availability", "coverUrl", "createdAt", "creatorId", "id", "locationEnabled", "locationGeohash", "locationLabel", "locationLat", "locationLng", "locationPlaceId", "locationPrecisionKm", "locationRadiusKm", "locationVisibility", "responseSla", "updatedAt", "vipOnly", "visibilityMode", "websiteUrl") SELECT "allowDiscoveryUseLocation", "availability", "coverUrl", "createdAt", "creatorId", "id", "locationEnabled", "locationGeohash", "locationLabel", "locationLat", "locationLng", "locationPlaceId", "locationPrecisionKm", "locationRadiusKm", "locationVisibility", "responseSla", "updatedAt", "vipOnly", "visibilityMode", "websiteUrl" FROM "CreatorProfile";
