...
INSERT INTO "new_CreatorProfile" ("allowDiscoveryUseLocation", "availability", "coverUrl", "createdAt", "creatorId", "id", "locationGeohash", "locationLabel", "locationRadiusKm", "locationVisibility", "responseSla", "updatedAt", "vipOnly", "visibilityMode", "websiteUrl") SELECT "allowDiscoveryUseLocation", "availability", "coverUrl", "createdAt", "creatorId", "id", "locationGeohash", "locationLabel", "locationRadiusKm", "locationVisibility", "responseSla", "updatedAt", "vipOnly", "visibilityMode", "websiteUrl" FROM "CreatorProfile";
