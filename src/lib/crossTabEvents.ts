...
const STORAGE_PREFIX = "novsy:event:";
...
function shouldProcess(payload: AppEventPayload): boolean {
...
export function emitAppEvent(eventName: string, detail: any) {
  if (typeof window === "undefined") return;
  initCrossTabEvents();
