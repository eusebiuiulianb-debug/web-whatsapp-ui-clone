...
export function AnalyticsPanel() {
  ...
  async function loadSales() {
    try {
      ...
      setSalesByRange(next);
    } catch (err) {
      console.error(err);
      setSalesError("No se pudo cargar el dashboard de ventas.");
  ...
  const breakdownRows = useMemo(() => {
    ...
    return [
      { id: "extras", label: "Extras", value: breakdown.extrasAmount },
      { id: "tips", label: "Propinas", value: breakdown.tipsAmount },
      { id: "gifts", label: "Regalos", value: breakdown.giftsAmount },
      { id: "subs", label: "Subs", value: breakdown.subscriptionsAmount },
      { id: "packs", label: "Packs/Bundles", value: breakdown.packsAmount + breakdown.bundlesAmount },
    ];
  }, [salesSummary]);
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <h2 className="text-xl font-semibold">Analítica interna</h2>
