        ...
        {positioned.map((rec) => {
          ...
          return (
            <button
              ...
              className="group absolute rounded-full border border-[color:rgba(var(--brand-rgb),0.5)] bg-[color:rgba(var(--brand-rgb),0.18)] shadow-2xl shadow-black/40 focus:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--ring)]"
              style={{
                width: rec.size,
                height: rec.size,
                left: "50%",
            ...
            >
              <div className="absolute inset-0 rounded-full bg-[color:rgba(var(--brand-rgb),0.16)] opacity-0 group-hover:opacity-100 group-focus:opacity-100 transition" />
              <div className="h-full w-full rounded-full overflow-hidden flex items-center justify-center text-lg font-semibold text-[color:var(--text)]">
                {rec.avatarUrl ? (
              ...
              <div className="pointer-events-none absolute left-1/2 top-full z-10 mt-3 w-52 -translate-x-1/2 rounded-xl border border-[color:var(--surface-border)] bg-[color:var(--surface-1)] p-3 opacity-0 shadow-lg shadow-black/30 transition group-hover:opacity-100 group-focus:opacity-100">
                <div className="text-sm font-semibold text-[color:var(--text)]">{rec.displayName}</div>
                <div className="text-xs text-[color:var(--muted)] space-y-1 mt-1">
